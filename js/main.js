...
const dataExchange = apiData([renderPictures, openPicture], console.log, console.error); // Инициализация интерфейса для работы с данными постов

dataExchange.select(); // Загрузка постов с сервера, отрисовка на странице и инициализация просмотра поста в модальном окне

uploadPicture(dataExchange.insert); // Инициализация модального окна и обработчиков для загрузки постов на сервер / передаем колбэк для отправки данных на сервер
