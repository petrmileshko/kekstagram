 ...
 * onSuccesReading = [ 'функция для вывода данных на главную страницу', 'функция для вывода поста в модальное окно при клике']
 * onFailSelect - Обработка ошибки (чтения данных) и вывод сообщения
 */
